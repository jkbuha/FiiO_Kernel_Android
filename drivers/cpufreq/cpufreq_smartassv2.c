 ...
 */
#define DEFAULT_AWAKE_IDEAL_FREQ 1008000	/* X5iii: mid clock for snappy screen-on */
 ...
 * also when suspended).
 */
#define DEFAULT_SLEEP_IDEAL_FREQ 696000		/* X5iii: floor clock, ample for screen-off audio */
 ...
 */
#define DEFAULT_RAMP_UP_STEP 200000		/* X5iii: ~one freq step */
 ...
 */
#define DEFAULT_RAMP_DOWN_STEP 200000		/* X5iii: ~one freq step */
 ...
 */
#define DEFAULT_SLEEP_WAKEUP_FREQ 1416000	/* X5iii: snappy on wake, not full 1704 */
...
static int __init cpufreq_smartass_init(void)
{
	...
	// Scale up is high priority (create_rt_workqueue was removed post-2.6.35;
	// use alloc_workqueue WQ_HIGHPRI on this 3.0 kernel)
